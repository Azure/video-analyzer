...
_INFERENCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sequence_id', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.sequence_id', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='classification', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.classification', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='motion', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.motion', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='entity', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.entity', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.text', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='event', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.event', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='other', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.other', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='extensions', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Inference.extensions', index=11,
...
_ENTITY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='microsoft.azure.media.live_video_analytics.extensibility.grpc.v1.Entity.id', index=3,
...
Inference = _reflection.GeneratedProtocolMessageType('Inference', (_message.Message,), dict(
  ...
  ExtensionsEntry = _reflection.GeneratedProtocolMessageType('ExtensionsEntry', (_message.Message,), dict(
...
InferenceOther = _reflection.GeneratedProtocolMessageType('InferenceOther', (_message.Message,), dict(
...
_INFERENCE_EXTENSIONSENTRY.has_options = True
_INFERENCE_EXTENSIONSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_EVENT_PROPERTIESENTRY.has_options = True
_EVENT_PROPERTIESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
